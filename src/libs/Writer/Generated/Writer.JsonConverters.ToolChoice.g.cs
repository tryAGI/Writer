...
{
    /// <inheritdoc />
    public class ToolChoiceJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Writer.ToolChoice>
    {
        /// <inheritdoc />
        public override global::Writer.ToolChoice Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::Writer.StringToolChoice? @string = default;
            global::Writer.JsonObjectToolChoice? jsonObject = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::Writer.ToolChoice(
                @string,
        ...
        public override void Write(
            ...
            global::Writer.ToolChoice value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
