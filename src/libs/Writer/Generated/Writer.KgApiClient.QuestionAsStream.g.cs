...
namespace Writer
{
    public partial class KgApiClient
    {
        ...
        partial void PrepareQuestionAsStreamRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Writer.QuestionRequest request);
        partial void ProcessQuestionAsStreamResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        /// </remarks>
        public async global::System.Collections.Generic.IAsyncEnumerable<global::Writer.QuestionResponseChunk> QuestionAsStreamAsync(
            ...
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareQuestionAsStreamArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareQuestionAsStreamRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Writer.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Writer.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "QuestionAsStream",
                                methodName: "QuestionAsStreamAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessQuestionAsStreamResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Writer.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                                ...
                                .Create(__stream).EnumerateAsync(__effectiveCancellationToken))
                            {
                                ...
                                var __streamedResponse = global::Writer.QuestionResponseChunk.FromJson(__content, JsonSerializerContext) ??
                                                       throw new global::Writer.ApiException(
            ...
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __enumerable = QuestionAsStreamAsync(
                request: __request,
                requestOptions: requestOptions,
                cancellationToken: cancellationToken);
