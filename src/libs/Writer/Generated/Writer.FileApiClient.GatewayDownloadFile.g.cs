...
namespace Writer
{
    public partial class FileApiClient
    {
        ...
        ///  --header "Authorization: Bearer &lt;token&gt;"
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> GatewayDownloadFileAsStreamAsync(
            string fileId,
            global::Writer.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Writer.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Writer.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GatewayDownloadFileAsync",
                ...
                else
                {
                    await global::Writer.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            try
                            {
                                ...
                                return new global::Writer.ResponseStream(__response, __content);
                            }
