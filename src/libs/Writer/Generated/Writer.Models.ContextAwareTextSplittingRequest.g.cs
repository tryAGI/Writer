...
namespace Writer
{
    ...
    public sealed partial class ContextAwareTextSplittingRequest
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Writer.JsonConverters.SplittingStrategyJsonConverter))]
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::Writer.SplittingStrategy Strategy { get; set; }
