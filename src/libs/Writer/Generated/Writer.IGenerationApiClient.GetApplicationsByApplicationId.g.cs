...
namespace Writer
{
    public partial interface IGenerationApiClient
    {
        ...
        ///  --header "Authorization: Bearer &lt;token&gt;"
        /// </remarks>
        global::System.Threading.Tasks.Task<global::Writer.AutoSDKHttpResponse<global::Writer.ApplicationWithInputs>> GetApplicationsByApplicationIdAsResponseAsync(
            string applicationId,
            global::Writer.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
