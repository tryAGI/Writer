...
namespace Writer
{
    public partial class TemplateClient
    {
        ...
        partial void PrepareCreateApplicationsByApplicationIdJobsArguments(
            ...
            global::Writer.GenerateApplicationAsyncRequest request);
        partial void PrepareCreateApplicationsByApplicationIdJobsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string applicationId,
            global::Writer.GenerateApplicationAsyncRequest request);
        partial void ProcessCreateApplicationsByApplicationIdJobsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateApplicationsByApplicationIdJobsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Writer.GenerateApplicationAsyncResponse> CreateApplicationsByApplicationIdJobsAsync(
            string applicationId,
        ...
        {
            var __response = await CreateApplicationsByApplicationIdJobsAsResponseAsync(
        ...
        /// --data-raw '{"inputs":[{"id": "Image ID", "value": ["12345"]}]}'
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Writer.AutoSDKHttpResponse<global::Writer.GenerateApplicationAsyncResponse>> CreateApplicationsByApplicationIdJobsAsResponseAsync(
            string applicationId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateApplicationsByApplicationIdJobsArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Writer.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Writer.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createApplicationsByApplicationIdJobs",
                                methodName: "CreateApplicationsByApplicationIdJobsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateApplicationsByApplicationIdJobsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Writer.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateApplicationsByApplicationIdJobsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Writer.GenerateApplicationAsyncResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Writer.AutoSDKHttpResponse<global::Writer.GenerateApplicationAsyncResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Writer.GenerateApplicationAsyncResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateApplicationsByApplicationIdJobsAsync(
                applicationId: applicationId,
                request: __request,
                requestOptions: requestOptions,
