...
namespace Writer
{
    ...
    public readonly partial struct CompositeContent : global::System.IEquatable<CompositeContent>
    {
        ...
        public global::Writer.TextFragment? Text { get; init; }
#else
        public global::Writer.TextFragment? Text { get; }
#endif
        ...
        /// </summary>
#if NET6_0_OR_GREATER
        public global::Writer.ImageFragment? Image { get; init; }
#else
        public global::Writer.ImageFragment? Image { get; }
#endif
        ...
        public CompositeContent(
            ...
            global::Writer.ImageFragment? image
            )
        {
            Text = text;
            Image = image;
